      ...
      <div className="container-home-div1">
        ...
        <div className="home-main-div-models">
          ...
          <div className="home-div-models">
            ...
            <Modal title="Driving More Efficiently" centered open={visible} onOk={() => setVisible1(false)} onCancel={() => setVisible1(false)} width={800}>
              <ol>
          ...
          <div className="home-div-models">
            ...
            <Modal title="Keeping Your Vehicle in Shape" centered open={visible2} onOk={() => setVisible2(false)} onCancel={() => setVisible2(false)} width={800}>
              <ol>
          ...
          <div className="home-div-models">
            ...
            <Modal title="Planning and Combining Trips" centered open={visible3} onOk={() => setVisible3(false)} onCancel={() => setVisible3(false)} width={800}>
              <ol>
          ...
          <div className="home-div-models">
            ...
            <Modal title="Other Solutions" centered open={visible4} onOk={() => setVisible4(false)} onCancel={() => setVisible4(false)} width={800}>
              <ol>
                <li>A warmed-up engine is more fuel-efficient than a cold one. <br/>
                ...
                <li>Use the “economy mode” feature if your vehicle has one.</li>
              </ol>
            </Modal>
          </div>
          ...
          <div className="home-div-models">
            ...
            <Modal title="Tips for Electric and Hybrid Vehicles" centered open={visible5} onOk={() => setVisible5(false)} onCancel={() => setVisible5(false)} width={800} >
              <ol>
                <li>Read the Owner's Manual</li>
                <li>Use the Economy Mode</li>
                <li>Avoid Hard Braking</li>
                <li>Keep the Battery Charged (EVs and Plug-in Hybrids Only)</li>
                <li>Use Accessories Wisely (such as heating, air conditioning, and entertainment systems)</li>
              </ol>
            </Modal>
          </div>
          ...
          <div className="home-div-models">
            ...
            <Modal title="What can I do to improve my fuel economy in cold weather?" centered open={visible6} onOk={() => setVisible6(false)} onCancel={() => setVisible6(false)} width={800}>
              <ol>
          ...
          <div className="home-div-models">
            ...
            <Modal title="What can I do to improve my fuel economy in hot weather?" centered open={visible7} onOk={() => setVisible7(false)} onCancel={() => setVisible7(false)} width={800}>
              <ol>
